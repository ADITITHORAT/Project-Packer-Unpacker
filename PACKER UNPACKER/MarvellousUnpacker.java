///////////////////////////////////////////////////////////////////////////////
//
//        File Name:    MarvellousUnpacker.java
//        Description:  Used to unpack a packed file and extract original files 
//                      using the header information (name, size).
//        Author:       Aditi Thorat
//        Date:         20/07/25
//
///////////////////////////////////////////////////////////////////////////////
...
public class MarvellousUnpacker {
    ...
    public void UnpackingActivity() {
        try {
            ...
            System.out.println("Unpacking activity done");
            System.out.println("-----------------------------------------------------------------------------------------------");
